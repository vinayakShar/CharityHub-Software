...
COMMENT ON COLUMN public.org_account.form_link IS 'This is a reference to their Charity creation documents/forms';
...
VALUES (1, 'NA', 'NA', 'test@test.com', 1, '2020-10-12', '2020-10-12 09:54:43', 1, 'test', 'test');

INSERT INTO public.user_account (account_id, first_name, last_name, email, address_id, create_date, last_update, active, password, username)
VALUES (2, 'NA', 'NA', 'test2@test.com', 1, '2020-10-12', '2020-10-12 09:54:43', 1, 'test2', 'test2');

INSERT INTO public.user_account (account_id, first_name, last_name, email, address_id, create_date, last_update, active, password, username)
VALUES (3, 'NA', 'NA', 'test3@test.com', 1, '2020-10-12', '2020-10-12 15:19:07', 1, 'test3', 'test3');

INSERT INTO public.user_account (account_id, first_name, last_name, email, address_id, create_date, last_update, active, password, username)
VALUES (4, 'NA', 'NA', 'test4@test.com', 1, '2020-10-12', '2020-10-12 15:19:07', 1, 'test4', 'test4');
...
ALTER TABLE ONLY public.payment
    ADD CONSTRAINT payment_org_id_fkey
